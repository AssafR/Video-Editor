...
def design_window(title, geo, ico):
    root.title(title)
    root.geometry(geo)
    root.iconbitmap(ico)
...
design_window('Video Editor', "1000x490", 'icon.ico')
s = ttk.Style()
...
frame1 = ttk.LabelFrame(root, text='Fram Pos')
...
class menu_com():
    def open_file():
        ...
        scale.config(to=length_frame, value=0)
