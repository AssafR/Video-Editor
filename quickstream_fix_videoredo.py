# Source: https://github.com/Dan203/pytivo/blob/master/videoredo/interface.py
        ...
        try:
            try:
                ...
                try:
                    ...
                    # vrd_silent = comtypes.client.CreateObject('VideoReDo6.Application')  # check for v6 next
                except:
                    try:
            ...
            try:
                ...
                if os.path.isfile(profile_path):
                    ...
                    if self.vrd:
                        ...
                        # if self.vrd.FileOpenBatchPIDS(in_file, int(224, 32), int(192, 32)):
                        # if self.vrd.FileOpenBatch(in_file):
                            if self.vrd.FileSaveAs(out_file, profile_path):
                                print(self.vrd.IsOutputInProgress())
                                return True
                else:
...
src_file = r'S:\blackdder_pigeon.mkv'
src_file = r'R:\Old_Discs\0045 - סרט על וקנין גולמי - CD\CAPTURE_02_12_03_09_30_21PM.MPG'
src_file = r'R:\Old_Discs\0039 - Quantum Leap - CD\MPEGAV\AVSEQ01.MPG'
vrd = VideoReDo()
if (vrd.quick_stream_fix(src_file, decrypt=False, output_folder='F:\\')):
    time.sleep(35)
    print(f'Success fixing file {src_file}')
else:
    print(f'Failure fixing file {src_file}')
